...
public class JDBC02 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//1. 지정된 스트링명을 가지는 클래스 또는 인터페이스에 경로를 알림
			Class.forName("oracle.jdbc.OracleDriver"); //오라클드라이버
			...
			//3. Statment : 인터페이스를 이용하여 SQL문장을 등록
			Statement st=con.createStatement(); //SQL서버에서 Statement작동
